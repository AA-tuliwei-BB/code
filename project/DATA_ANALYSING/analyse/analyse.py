...
mp = {} # the first -> sum ; the second -> cnt
nu = [0] * 1000000
ns = [0] * 1000000
nt = [0] * 1000000
t = [0] * 1000000
...
#			print(nu[j])
		...
		for r in range(st + width - 1, len(data) - 2) :
			s = ''
...
with open('result', 'w') as f :
	for i in range(0, len(a)) : # a[i] is the price string
		tmpa, tmpb = mp[a[i]]
#		if tmpb < 10 : continue
		Exp = tmpa / tmpb
#		if Exp < 5 : continue
